...
// if true, use docker container, if false use local
const isDockerDB = true;
...
let mongoUrlDockerCompose = "mongodb://admin:admin@mongodb:27017";

if (isDockerDB) {
  mongoUrlLocal = mongoUrlDockerCompose;
}
